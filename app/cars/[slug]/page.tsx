...
export default async function CarDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const specs = [
    ...
    ["Elektr yurish masofasi",car.range_km?`${car.range_km} km`:null],
    ["0–100 km/soat",car.acceleration_0_100_sec?`${car.acceleration_0_100_sec} s`:null],
    ["Tezkor zaryadlash",car.charging_time_minutes?`${car.charging_time_minutes} min`:null],
    [x.seats,car.seats],
