...
const TYPE_BY_EXT: Record<string,string> = { jpg:"image/jpeg", jpeg:"image/jpeg", jfif:"image/jpeg", png:"image/png", webp:"image/webp" };
export class AdminImageService {
  ...
  upload(carId: string, file: File, colorId?: string | null) {
    ...
    if (!contentType) throw new Error("Faqat JPG, JPEG, JFIF, PNG yoki WEBP formatdagi fayllar qabul qilinadi");
