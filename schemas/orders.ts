...
export const orderSchema = z.object({ carId: idSchema, purchaseType: z.enum(["cash","online","credit","installment"]), financingProgramId: idSchema.optional(), notes: z.string().max(2000).optional() });
